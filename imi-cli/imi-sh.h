...
#define IMISH_HSLSD   0x200
#define IMISH_OLSRD   0x400
#define IMISH_ICRPD   0x800
#define IMISH_FRPD    0x1000
#define IMISH_VRRPD   0x2000
#define IMISH_LLDPD   0x4000
#define IMISH_VPND    0x8000
...
#define IMISH_EXPAND  0
#endif/*HAVE_EXPAND_ROUTE_PLATFORM*/


#define IMISH_ALL	IMISH_ZEBRA|IMISH_RIPD|IMISH_RIPNGD|IMISH_OSPFD| \
		IMISH_OSPF6D|IMISH_BGPD|IMISH_ISISD|IMISH_BABELD|IMISH_PIMD IMISH_EXPAND
