...
#define IMISH_ALL	  IMISH_ZEBRA|IMISH_RIPD|IMISH_RIPNGD|IMISH_OSPFD|IMISH_OSPF6D|IMISH_BGPD|IMISH_ISISD|IMISH_BABELD|IMISH_PIMD|IMISH_OLSRD|IMISH_HSLSD|IMISH_FRPD
#define IMISH_RMAP	  IMISH_ZEBRA|IMISH_RIPD|IMISH_RIPNGD|IMISH_OSPFD|IMISH_OSPF6D|IMISH_BGPD|IMISH_BABELD
#define IMISH_INTERFACE	  IMISH_ZEBRA|IMISH_RIPD|IMISH_RIPNGD|IMISH_OSPFD|IMISH_OSPF6D|IMISH_ISISD|IMISH_BABELD|IMISH_PIMD|IMISH_OLSRD|IMISH_HSLSD|IMISH_FRPD
...
extern int imish_read_config (char *config_default);//读取配置文件并执行命令
//imi-sh_cmd.c
