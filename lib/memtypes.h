...
enum
{
  ...
  MTYPE_RSVP_IP_PATH,
  MTYPE_RSVP_IF,
  MTYPE_RSVP_TUNNEL_IF,
  MTYPE_RSVP_TUNNEL_IF_PATH_OPTION,
  MTYPE_RSVP_LSP,
  MTYPE_RSVP_PACKET,
  MTYPE_RSVP_PACKET_FIFO,
  MTYPE_RSVP_ROUTE_INFO,
  MTYPE_RSVP_SENDER_HASH_ENTRY,
  MTYPE_RSVP_PSB_IPV4_SENDER_HASH_ENTRY,
  MTYPE_RSVP_PSB_IPV6_SENDER_HASH_ENTRY,
  MTYPE_RSVP_PSB_SESSION_AVL_ENTRY,
  MTYPE_RSVP_PSB,
  MTYPE_RSVP_RSB,
  MTYPE_RSVP_DETOUR_ELEMENT_INFO_IPV4,
  MTYPE_RSVP_DETOUR_ELEMENT_INFO_IPV6,
  MTYPE_LABEL_MAP,
  MTYPE_MPLS_XC,
  MTYPE_MPLS_XC_ILM,
  MTYPE_MPLS_XC_NHLFE,
  ...
  MTYPE_LDP_TOP,
  MTYPE_LDP_IF_INFO,
  MTYPE_LDP_ROUTE_INFO,
  MTYPE_LDP_HELLOADJ,
  MTYPE_LDP_HELLOMGR,
  MTYPE_LDP_PEER,
  MTYPE_LDP_PEER_HASH_IFINDEX_ENTRY,
  MTYPE_LDP_FECUNION,
  MTYPE_LDP_LIB,
  MTYPE_LDP_LABEL,
  MTYPE_LDP_LABEL_MAP_ENTRY,
  MTYPE_LDP_PACKET,
  MTYPE_LDP_PACKET_FIFO,
  MTYPE_LDP_ADDR,
  MTYPE_LDP_FEC_RT,
